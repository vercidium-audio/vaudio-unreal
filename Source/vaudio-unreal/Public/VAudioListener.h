...
public:
	...
	// TODO: retype to TArray<AVAudioEmitterBase*> once AVAudioSource/AVAudioContinuous exist
	// (actor_plan.md items 3/3b) - both are raytracing targets and must be assignable here.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Vercidium Audio|Listener")
